    ...
    <div id="vd" class="space-y-4">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div class="p-3 bg-slate-900 border border-slate-800 rounded-xl">
          <p class="text-[10px] text-slate-400">Statutory Auth</p>
          <h3 class="text-lg font-bold text-emerald-400 mt-1">DSC Sign Active</h3>
        </div>
        <div class="p-3 bg-slate-900 border border-slate-800 rounded-xl">
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-4">
        <h2 class="font-bold text-sm mb-3">Audit Logs (Statutory Sign & SHA-256 Verified)</h2>
      ...
      document.getElementById('ol').innerHTML = obs.map(o => `
        <div class="p-2.5 bg-slate-950 border border-slate-800 rounded flex justify-between items-center">
          <div>
            ...
            <div class="text-[10px] text-amber-400">Signed By: ${o.officer_name} (${o.officer_role}) | Cert: ${o.dgms_cert_no}</div>
          ...
          <div class="text-right">
            ...
            <span class="text-[10px] text-emerald-400 font-mono">DSC VALID</span>
          </div>
        </div>
    ...
    return [
        {
            ...
            "sha256_hash": a.sha256_hash, "timestamp": a.timestamp.strftime("%Y-%m-%d %H:%M")
        }
        for a in res
    ]
