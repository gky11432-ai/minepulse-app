    ...
    if not audits:
        ...
        for a in audits:
            ...
            r = (
                ...
                f"<div style='font-weight: bold;'>{a.officer_name}</div>"
                f"<div style='font-size: 11px; color: #555;'>{a.officer_role}</div>"
                f"<div style='font-family: monospace; font-size: 10px; color: #1e3a8a;'>Lic: {a.dgms_cert_no}</div>"
                f"</td>"
