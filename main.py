...
def trigger_emergency_dispatch(mine_name: str, issue: str):
    """Statutory Emergency Webhook: Broadcasts critical hazard to rescue station"""
    print(f"[EMERGENCY SIREN] CMR CRITICAL ALERT: {mine_name} -> {issue}. Auto-Relay Command Sent.")
    ...
    <div id="vd" class="space-y-4">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div class="p-3 bg-slate-900 border border-slate-800 rounded-xl">
          <p class="text-[10px] text-slate-400">Emergency Protocol</p>
          <h3 class="text-lg font-bold text-emerald-400 mt-1">Siren Relay Armed</h3>
        </div>
        <div class="p-3 bg-slate-900 border border-slate-800 rounded-xl">
