...
# Database Config (PostgreSQL / SQLite Auto-Switch)
...
# ==========================================
# 🔌 PLUG-AND-PLAY AUTO-LOADER ENGINE
# (Modules folder ke har naye feature ko auto-attach karega)
# ==========================================
MODULES_DIR = "modules"
if os.path.exists(MODULES_DIR):
    for fname in os.listdir(MODULES_DIR):
        if fname.endswith(".py") and not fname.startswith("__"):
            mod_name = f"{MODULES_DIR}.{fname[:-3]}"
            try:
                ...
                print(f"⚠️ Plugin Load Error in {mod_name}:", e)
