# modules/pwa.py - DGMS Air-Gapped Zero-Dependency Service Worker
from fastapi import APIRouter
from fastapi.responses import Response

router = APIRouter(tags=["PWA Engine"])

SW_JS_CONTENT = """// MinePulse Core Air-Gapped Service Worker v50
const CACHE_NAME = 'minepulse-industrial-vault-v50';
...
self.addEventListener('fetch', (e) => {
  ...
  // Pure Cache-First for UI (Guaranteed instant load offline)
  e.respondWith(
