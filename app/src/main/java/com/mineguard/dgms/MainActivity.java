...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auditSyncManager.setListener((officerName, category, isDanger) -> runOnUiThread(() -> {
            if (isDanger && safetyService != null) {
                ...
                Toast.makeText(MainActivity.this, "🚨 ख़तरा अलर्ट: " + officerName + " (" + category + ") - सायरन चालू!", Toast.LENGTH_LONG).show();
            } else {
        ...
        cardSiren.setOnClickListener(v -> {
            ...
            if (safetyService.getHardwareController().isSirenActive()) {
                ...
                Toast.makeText(this, "🚨 ऑफ़लाइन सायरन बजाया गया!", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void setupOfflineMeshListeners() {
