...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Listen for new audits synced from OTHER phones
        auditSyncManager.setListener((officerName, category) -> runOnUiThread(() ->
                Toast.makeText(MainActivity.this, "🔄 नए सिंक प्राप्त: " + officerName + " (" + category + ")", Toast.LENGTH_SHORT).show()
        ));
        ...
        cardSiren.setOnClickListener(v -> {
            ...
            if (safetyService.getHardwareController().isSirenActive()) {
                ...
                AlarmLogManager.AuditEntry sosEntry = alarmLogManager.logLocalEntry(
                        authManager.getOfficerName(), authManager.getOfficerId(), authManager.getOfficerRole(), "EMERGENCY_SOS", "MANUAL_TRIGGER"
                );
                auditSyncManager.broadcastAudit(sosEntry);
                Toast.makeText(this, "🚨 सायरन सक्रिय - सभी फ़ोनों में दर्ज!", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull android.view.MenuItem item) {
        ...
        if (id == R.id.nav_sos) {
            ...
            RegisterDialogHelper.showEntryDialog(this, String.valueOf(id), item.getTitle().toString(), 
                    alarmLogManager, auditSyncManager, (safetyService != null ? safetyService.getBleMeshManager() : null));
        }
        return true;
    }
