...
public class MineSafetyService extends Service {
    ...
    public void onCreate() {
        ...
        try {
            ...
            startForeground(NOTIF_ID, buildForegroundNotification("🟢 DGMS Safety Console Active"));

            AuthManager auth = new AuthManager(this);
            String officerTag = auth.getOfficerName() + "~" + auth.getOfficerRole();
            bleMeshManager.startOfflineMesh(officerTag);
    ...
    private Notification buildForegroundNotification(String statusText) {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("MineGuard 24/7 Console")
