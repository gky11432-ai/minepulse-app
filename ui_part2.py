# ui_part2.py - Autonomous Native Logic & Original DGMS Ramp Siren Engine
...
PART2 = """
  <script>
    ...
    // 2. Hardware-Level Network State Switcher
    ...
    // 3. Original DGMS Pitch-Ramp Siren & Hardware Vibration
    function initAudio() {
      if (!audioCtx) {
    ...
    function scheduleSirenRamp() {
      ...
      sirenOsc.frequency.linearRampToValueAtTime(800, now + 1.6);
    }
    ...
    function triggerBroadcastSOS() {
      ...
      alert('🚨 DGMS STATUTORY EVACUATION SIREN ENGAGED!\\n\\nContinuous horn & vibration active.');
    }
    ...
    // Dono siren triggers (Button 1: Simulate Gas Spike, Button 2: SOS)
