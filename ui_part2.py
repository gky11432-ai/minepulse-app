# ui_part2.py - Autonomous Native Logic & Guaranteed Siren Engine
...
PART2 = """
  <script>
    ...
    // 3. Audio Siren with Guaranteed Unlock
    function initAudio() {
      if (!audioCtx) {
