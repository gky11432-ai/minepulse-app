# ui_part1.py - Industrial Base Layout (Map Isolated)
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .beacon-pulse {
      animation: ping-ring 2s cubic-bezier(0, 0.2, 0.8, 1) infinite;
    }
    .radar-rotator {
      transform-origin: 300px 105px;
...
<body>
  ...
  <div id="siren-banner" class="hidden siren-bar">
    <span>🚨 DGMS CMR 153: PIT EVACUATION SIREN ENGAGED</span>
