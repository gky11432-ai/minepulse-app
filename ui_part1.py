# ui_part1.py - Industrial Shell, Base DOM & Embedded Tactical Map Engine
...
<body>
  ...
  <div class="container">
    ...
    <div id="vd">
      ...
      <!-- Live Tactical Pit Radar Map Section -->
      <div class="card">
        ...
        <div style="position:relative; width:100%; height:180px; background:#050c1a; border-radius:8px; border:1px solid #1e293b; overflow:hidden;">
          <canvas id="mine-map-canvas" style="display:block; width:100%; height:100%;"></canvas>
        </div>
      </div>
    ...
    <!-- Self-Contained High-Definition Tactical Map Script -->
    <script>
      (function() {
        var radarAngle = 0;
        function renderPitMap() {
          ...
          var w = rect.width || cv.parentElement.clientWidth || 340;
          var h = 180;
          ...
          // Statutory Leasehold (Red Boundary)
          ...
          requestAnimationFrame(renderPitMap);
        }

        window.addEventListener('load', function() {
          requestAnimationFrame(renderPitMap);
        });
        // Fallback for immediate trigger
        setTimeout(function() { requestAnimationFrame(renderPitMap); }, 100);
      })();
    </script>
"""
